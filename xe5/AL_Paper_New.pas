...
// Modified: 2019-03-11     By Agócs László Hun. StellaSOFT
...
Uses
    ...
    Extctrls, Messages, Dialogs, Forms, NewGeom, DGrafik, B_Spline, Szoveg,
...
procedure TALSablon.DrawNode(p: TPoint2d; m: integer; Fill: boolean;
  co: TColor);
var pp: TPoint;
begin
