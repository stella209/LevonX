...
type
  ...
  procedure Strecth(Src, Dst: TBitmap; filter: TFilterProc; fwidth: single); overload;
  procedure Strecth(Src: TBitmap; filterIndex: integer; w,h: integer); overload;
...
begin
  Try
     ...
     bmp.Width := w;
     bmp.Height:= h;
     Strecth(Src,bmp,ResampleFilters[filterIndex].Filter, ResampleFilters[filterIndex].Width);
  Finally
     Src.Assign(bmp);
     bmp.Free;
  End;
